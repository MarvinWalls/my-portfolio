  ...
  return (
    <section id="home" className="text-center py-8 bg-gradient-to-r from-gray-800 to-gray-900 text-white flex flex-col justify-center items-center min-h-screen">
      <div className="container mx-auto">
        ...
        <p className="text-xl mt-4 fade-in">SAP Analytics Cloud Architect | High-Concurrency Dashboard Architecture | Advanced SAC Scripting | Financial Systems Optimization & Data Governance</p>
