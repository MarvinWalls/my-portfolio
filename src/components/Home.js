...
const Home = () => {
  return (
    <section id="home" className="text-center py-12 bg-gradient-to-r from-gray-800 to-gray-900 text-white flex flex-col justify-center items-center min-h-screen">
